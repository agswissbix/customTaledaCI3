<script type="text/javascript">
    $("#results_table tbody").height($(window).height()*0.7);
...
#results_table tbody,
#results_table thead { display: block; }
...
#results_table tbody td, #results_table thead th {
    /* width: 20%; */ /* Optional */
    min-width: 30px;
    /* white-space: nowrap; */
}
...
<div id="results_<?=$tableid?>" class="results" style="<?=$results_height?>;<?=$font?>;width: 100%;" data-tableid="<?=$tableid?>">
    ...
    <div class="results_rows" style="<?=$table_container_height?>;">
        <table class="scroll" id="results_table" style="width: 100%;table-layout: fixed;white-space: nowrap;" border="0" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    <th class="th0" style=""></th>
                    <?php
                    foreach ($columns as $key => $column) {
                        ...
                        ?>
                            <th class="th<?=$key?>" style=""><?=$key.$column['desc']?><span style="color: transparent"><?=$span?></span></th>
                        <?php
                        }
