    ...
    function salva_preventivocarrozzeria(el)
    {
        var fd = new FormData();
        ...
        $.ajax({
            url: '<?= controller_url()."winteler_salva_preventivocarrozzeria" ?>',
            method: 'POST',
            data: fd,
            cache: false,
            contentType: false,
    ...
    <div class="row">
        ...
        <div class="input-field col s12" >
            <a style="width: 100%" class="waves-effect waves-light btn" onclick="salva_preventivocarrozzeria(this)">Salva</a>
        </div>
        <div class="row" >
