...
<div class="container" style="max-width: none !important">   
    ...
    <div id="generazionedocumenti"  class="row">
        <div class="col s9">
            <iframe src="<?=base_url()."assets/documents/DOC001.pdf"?>" width="100%" height="80%"></iframe>
        </div>
        <div class="card col s3" style="padding: 20px">
            <div class="input-field col s12">
                <select>
                  ...
                  <option value="2" selected>Certificato di matrimonio</option>
                  ...
                  <option value="3">Notifica di arrivo</option>
            ...
            <div id="famigliari" class="input-field col s12" style="display: none">
                <p>
                <label>
                  <input type="checkbox" />
            ...
            <div class="input-field col s12">
                <div class="btn waves-effect waves-light" onclick="window.location.replace('<?=base_url()."index.php/sys_viewcontroller/custom_koelliker_collina2"?>')" >Salva e prosegui   
