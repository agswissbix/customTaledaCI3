...
$cell->addImage('..//'.$foto, array('width'=>135,'height'=>135,'align'=>'center'));    
...
$cell->addText('CURRICULUM VITAE',array('size'=>18,'align'=>'center'));
$cell->addTextBreak(1);
...
$table->addRow(30);
$cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText('Nome e Cognome',array('size'=>12),array('align'=>'right'));
...
$cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText('Indirizzo',array('size'=>12),array('align'=>'right'));
...
$cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText(utf8_decode(replace1252('Nazionalità')),array('size'=>12),array('align'=>'right'));
...
if ($candidato['dati']['permesso']<>''){
    ...
    $cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText(utf8_decode(replace1252($candidato['dati']['permesso'])));
}
...
$cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText(utf8_decode(replace1252($candidato['dati']['datanascita'])));
...
if($candidato['dati']['statocivile']!=''){
    ...
    $cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText(utf8_decode(replace1252($candidato['dati']['statocivile'])));    
}
$table->addRow(30);

$cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
if ($candidato['dati']['cellulare']!="")
    $cell->addText('Cellulare',array('size'=>12),array('align'=>'right'));
elseif($candidato['dati']['telefonofisso']!='')
    $cell->addText('Telefono',array('size'=>12),array('align'=>'right'));
...
if ($candidato['dati']['cellulare']!="")
    $cell->addText(utf8_decode(replace1252($candidato['dati']['cellulare'])));
else
    $cell->addText(utf8_decode(replace1252($candidato['dati']['telefonofisso'])));

$table->addRow(30);

$cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText('Indirizzo e-mail',array('size'=>12),array('align'=>'right'));

$cell = $table->addCell(500,array('valign'=>'top','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>0, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText("",array('align'=>'left'));

$cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
$cell->addText(utf8_decode(replace1252($candidato['dati']['email'])));

if ($candidato['dati']['paginaweb']<>""){
    $table->addRow(30);

    $cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText('Pagina web',array('size'=>12),array('align'=>'right'));

    $cell = $table->addCell(500,array('valign'=>'top','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>0, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText("",array('align'=>'left'));

    $cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText(utf8_decode(replace1252($candidato['dati']['paginaweb'])));  
}
...
if ($candidato['dati']['linkedin']<>""){
    ...
    $cell = $table->addCell(4000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText('LinkedIn',array('size'=>12),array('align'=>'right'));

    $cell = $table->addCell(500,array('valign'=>'top','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>0, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText("",array('align'=>'left'));

    $cell = $table->addCell(8500,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
    $cell->addText(utf8_decode(replace1252($candidato['dati']['linkedin'])));  
}
$patente="";
$altrepatenti="";
...
if ($recordNumber>0){
    ...
    foreach ($candidato['studi'] as $key => $studio) {
        ...
        //$cell->addText(chr(9).utf8_decode(replace1252($studio['tiposcuola'] . ", " . $studio['nomescuola']. ", " . $studio['paese']));
        ...
        if ($studio['estero']!="Si"){
            ...
            //$cell->addText(chr(9).$ScuolaElem.utf8_decode(replace1252($studio['nomescuolaelementare']. $studio['nomescuolamedia']. $studio['nomescuolaprofessionale']. $studio['nomescuolasuperiore']. $studio['nomeuniversita']));
...
if ($recordNumber>0){
    ...
    foreach ($candidato['soggiornilinguistici'] as $key => $soggiornolinguistico) {
        ...
        //$textrun->addText(utf8_decode(replace1252($soggiornolinguistico['citta']) . " " . $soggiornolinguistico['nazione'] . " - ");
        //$textrun->addText(chr(13).chr(10).chr(9).chr(9).$soggiornolinguistico['diploma'],array('bold'=>true));
        //$textrun->addText(" - " . utf8_decode(replace1252($soggiornolinguistico['esame']));
...
if ($recordNumber>0){
    ...
    foreach ($candidato['esperienzeprofessionali'] as $key => $esperienzaprofessionale) {
        ...
        $periodo= ($esperienzaprofessionale['annofine']<>"" ? "Dal " : ""). $esperienzaprofessionale['meseinizio'].".".$esperienzaprofessionale['annoinizio']. " ";
        ...
        */
        ...
        $textrun->addText(utf8_decode(replace1252($esperienzaprofessionale['azienda'])),array('bold'=>true));        
        ...
        if (strlen($esperienzaprofessionale['carica'])>0) {
            $table->addRow(30);
...
if ($recordNumber>0){
    ...
    foreach ($candidato['conoscenzelinguistiche'] as $key => $conoscenzalinguistica) {
        ...
        $cell = $table->addCell(9000,array('valign'=>'center','borderSize'=>0,'borderColor'=>'FFFFFF','spacing'=>0,'spaceAfter'=>0,'spaceBefore'=>10, 'cellMarginBottom'=>0, 'cellMarginTop'=>0));
        $cell->addText(chr(9).utf8_decode(replace1252($conoscenzalinguistica['conoscenzaorale'])); //"Orale: " . 
        $cell->addText(chr(13).chr(10).chr(9).utf8_decode(replace1252("Scritto: " . $conoscenzalinguistica['conoscenzascritta']));
        */
    ...
    //if ($conoscenzalinguistica['conoscenzaorale']!="Nessuna") {
        ...
        //    $cell->addText(chr(13).chr(10).chr(9)."Scritto: " . $conoscenzalinguistica['conoscenzascritta']);   
