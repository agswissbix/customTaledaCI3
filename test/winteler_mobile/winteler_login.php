                ...
                <div class="col s12 m6 card">
                    ...
                    <div class="card-content">
                      ...
                      <div class="input-field col s12">
                          <input placeholder="Utente" id="first_name" type="text" class="validate">
                          <label for="first_name">Utente</label>
                      </div>
                      </div>
                      <div class="row">
                          <div class="input-field col s12">
                    ...
                    <a href="winteler_menu.php" class="waves-effect waves-light btn">Login</a>
                </div>
            </div>
        </div>
    </body>
