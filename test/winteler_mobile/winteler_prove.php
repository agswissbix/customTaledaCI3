                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                ...
                                <label for="last_name">Nome e Cognome</label>
                            </div>
                            <div class="input-field col s12">
                                <input id="last_name" type="text" class="validate">
                                <label for="last_name">Indirizzo</label>
                            </div>
                            <div class="input-field col s12">
                                <input id="last_name" type="text" class="validate">
                            ...
                            <div class="input-field col s12">
                                <a href="signature_pad-master/docs/index.html" style="width: 100%" class="waves-effect waves-light btn">Firma</a>
                            </div>
                            <div class="input-field col s12" >
